"""Test Module for Puzzles in Day 11: Monkey in the Middle"""

import logging
from pathlib import Path
from pytest import fixture, mark

from puzzle import load, parse, part1, part2
...
class TestPartOne(AoCTest):
    def test_part1_on_sample_data(self, sample_input):
        ...
        assert part1(sample_input) == 10605, f"Part 1 - Test Input ❌"

    def test_part1_on_game_input(self, game_input):
        LOGGER.info(f"Part 1: Game Input")
        assert part1(game_input) == 117624, f"Part 1 - Game Input ❌"
...
class TestPartTwo(AoCTest):
    def test_part2_on_sample_data(self, sample_input):
        ...
        assert part2(sample_input) == 2713310158, f"Part 2 - Test Input ❌"

    def test_part2_on_game_input(self, game_input):
        LOGGER.info(f"Part 2: Game Input")
        assert part2(game_input) == 16792940265, f"Part 2 - Game Input ❌"
