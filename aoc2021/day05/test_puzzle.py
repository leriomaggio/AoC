"""Test Module for Puzzles in Day 05: Hydrothermal Venture"""
...
class AoCTest:
    ...
    def game_input(self) -> list[int]:
        ...
        input_filepath = Path(__file__).with_name("input.05")
        return load(open(input_filepath).read().strip().splitlines())
...
class TestPartOne(AoCTest):
    def test_part1_on_sample_data(self, sample_input):
        ...
        assert part1(sample_input) == 5, f"Part 1 - Test Input ❌"

    def test_part1_on_game_input(self, game_input):
        LOGGER.info(f"Part 1: Game Input")
        assert part1(game_input) == 4728, f"Part 1 - Game Input ❌"
...
class TestPartTwo(AoCTest):
    ...
    def test_part2_on_game_input(self, game_input):
        ...
        assert part2(game_input) == 17717, f"Part 2 - Game Input ❌"
